...
model_path = os.path.join(os.path.dirname(__file__),"Breast_cancer_prediction.sav")
try:
...
def main():
    ...
    if st.button("Predict Tumor Type"):
        diagnosis = Breast_cancer([mean_radius, mean_texture, mean_perimeter, mean_area, mean_smoothness,
